...
const kapcsi = document.getElementById("kapcsi");
if (kapcsi) {
    kapcsi.addEventListener("submit", function(event) {
        event.preventDefault(); // Megakadályozza az űrlap elküldését
        alert("Az üzenetét rögzítettük!");
        kapcsi.reset(); // Törli az űrlap tartalmát
    });
}
